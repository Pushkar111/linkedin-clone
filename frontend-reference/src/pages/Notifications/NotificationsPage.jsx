  ...
  return (
    <>
      ...
      <div className="min-h-screen bg-gray-100 py-2 sm:py-4 lg:py-6">
        <div className="max-w-5xl mx-auto px-2 sm:px-4 lg:px-6 xl:px-8">
          {/* Header */}
          <div className="bg-white rounded-lg shadow-sm p-3 sm:p-4 lg:p-6 mb-3 sm:mb-4">
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-3 mb-4">
              <h1 className="text-xl sm:text-2xl font-bold text-color-text-darker">
                Notifications
              </h1>
            ...
            <div className="flex flex-col sm:flex-row flex-wrap items-stretch sm:items-center gap-2 sm:gap-3">
              ...
              <select
                ...
                className="w-full sm:w-auto px-3 sm:px-4 py-2 border border-gray-300 rounded-lg text-xs sm:text-sm focus:outline-none focus:ring-2 focus:ring-color-button-blue focus:border-transparent"
              >
